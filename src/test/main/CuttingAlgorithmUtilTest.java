...
public class CuttingAlgorithmUtilTest {
    ...
    void convertProteinSequenceToDna() {
        ...
        ArrayList<Amino> alternateAminos = SystemUtil
                .loadAlternateAminos("data/test/TestAlternateAminoForCuttingAlgorithmData");
        Integer startingLoc = 20;
        Integer endingLoc = 40;

        // When.
        Float cost = CuttingAlgorithmUtil.oligoCost(costOfCodon, costOfDegenerateCodon, alternateAminos, startingLoc,
                endingLoc);
        // Then.
